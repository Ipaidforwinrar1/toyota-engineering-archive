...
CREATE TABLE IF NOT EXISTS component_quality (
...
CREATE INDEX IF NOT EXISTS idx_doc_component_confidence ON document_components(confidence);
CREATE INDEX IF NOT EXISTS idx_quality_generic ON component_quality(is_generic);
